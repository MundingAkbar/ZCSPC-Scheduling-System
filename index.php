          ...
          <div class="row">
                <div class="col-md-2">
                    <div class="image-upload">
                                ...
                                <input type="file" id="file-up-1" accept="image/*" onchange="showPreview(event);">
                    </div>
                </div>
                <div class="col-md-10">
                    ...
                    <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="card border-dark">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="col">
                                                    <div class="row mb-2">
                                                        <label for="birthday"> Date of Birth:</label>
                                                         <input type="date" id="birthday" class="form-control" aria-label="Last name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row g-3">
                                            ...
                                            <div class="row g-3">
                                                    <div class="col-4">
                                                        <input type="tel" class="form-control" placeholder="Contact Number" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}">
                                                    </div>
                                            </div>
                                            <p>Home Address:</p>
                                            <div class="row g-3">
                                    ...
                                    <div class="card mt-2 border-dark">
                                        ...
                                        <div class="card-body">
                                           <div class="row g-3 mb-2">
                                                ...
                                                <div class="col">
                                                    <input type="text" class="form-control" placeholder="Mather's name">
                                                </div>
                                           </div>
                                           <div class="row g-3 mb-2">
                                                <div class="col">
                                           ...
                                           <div class="row g-3 mb-3">
                                                <div class="col">
                                                    <input type="text" class="form-control" placeholder="Educational Level">
                                                </div>
                                                <div class="col">
                                                    <input type="text" class="form-control" placeholder="Educational Level">
                                                </div>
                                           ...
                                           <div class="row g-3">
                                                ...
                                                <input type="text" class="form-control mb-2" placeholder="Guardian's Name">
                                                            <input type="text" class="form-control mb-2" placeholder="Relationship">
                                                            <input type="text" class="form-control mb-2" placeholder="Occupation">
                             ...
                             <div class="card mt-2 border-dark">
                                ...
                                <div class="card-body">
                                    <input type="text" class="form-control mb-2" placeholder="Name of School Last Attended">
                                    <input type="text" class="form-control mb-2" placeholder="Address of School Last Attended">
                                    <input type="text" class="form-control mb-2" placeholder="Course/Track or Strand Taken">
                                    <div class="row g-3">
                                        <div class="col">
                                            ...
                                            <div class="card border-secondary mb-2">
                                                <div class="card-body">
                                                    ...
                                                    <div class="checkbox mb-2">
                                                        <label><input type="checkbox" value=""> DEPEd-ALS</label>
                                                    </div>
                                                    <div class="checkbox mb-2">
                                                        <label><input type="checkbox" value=""> Tech-Voc School</label>
                                                    </div>
                                                    <input type="text" placeholder="Others" class="form-control mb-2">
                                                    </div>
                                            </div>
                                            <input type="text" placeholder="Sports Affliction" class="form-control mb-2">
                                            <input type="text" placeholder="Special Takens/Skills" class="form-control mb-2">
                                        </div>
                                        <div class="col">
                                            <label for="date_graduated">Date Graduated/Completed:</label>
                                            <input type="date" id="date_graduated" placeholder="Date Graduated" class="form-control mb-2" value="mm/dd/yyyy">
                                            <input type="text" placeholder="Learner's Residence Number (LRN)" class="form-control mb-2">
                                            <input type="text" placeholder="Year/Semester of Last Attendance" class="form-control mb-2">
                                            <input type="text" placeholder="Honors/Awards Received" class="form-control mb-2">
                                            <input type="text" placeholder="NC Qualifications" class="form-control mb-2">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-dark mt-2">
                                ...
                                <div class="card-body">
                                    <input type="text" placeholder="First Choice" class="form-control mt-2">
                                    <input type="text" placeholder="Second Choice" class="form-control mt-2">
                                    <input type="text" placeholder="Third Choice" class="form-control mt-2">
                                </div>
                            </div>
                             <!-- end of courses -->
                    </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
     ...
     <div class="input-group mb-3">
      ...
      <div class="modal-footer">
        <a type="button" class="btn border-danger" href="admin.php">Login</a>
