  ...
  <div class="container-fluid">
    ...
    <div class="row">
        <div class="collapse navbar-collapse" id="navbarText">
                ...
                <li class="nav-item">
                <a class="nav-link" href=""><span><i class="fas fa-user-cog"></i></span> Profile</a>
                </li>
                <li class="nav-item">
                <a class="nav-link btn border-light" href="index.php"><span><i class="fas fa-sign-out-alt"></i></span> Logout</a>
                </li>
            </ul>
        </div>
    </div>
